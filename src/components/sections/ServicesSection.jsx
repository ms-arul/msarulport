...
/* ═══════════════════════════════════
   SERVICE CARD — staggered waterfall
═══════════════════════════════════ */
...
const ServicesSection = () => {
  ...
  return (
    <SectionWrapper id="services" className="min-h-screen flex items-center justify-center bg-primary/30 py-24 lg:py-32 overflow-hidden">
      <Circles />
