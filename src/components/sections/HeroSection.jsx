...
const HeroSection = () => {
  ...
  return (
    <SectionWrapper id="home" className="min-h-screen relative overflow-hidden">
      <div className="bg-primary/60 min-h-screen relative">
        ...
        <div className="w-full min-h-screen bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
          <div className="container mx-auto min-h-screen flex flex-col justify-center px-4 pt-[110px] pb-[120px] xl:pt-40 xl:pb-0 xl:px-0 text-center xl:text-left">
            ...
            >
              <div className="relative">
                ...
                <div
                  ...
                  style={{ padding: "2px", background: "linear-gradient(135deg, #F13024, #7c3aed)" }}
