...
const ContactSection = () => {
  ...
  return (
    <SectionWrapper id="contact" className="min-h-screen flex items-center justify-center bg-primary/30 py-24 lg:py-32 overflow-hidden">
      <Circles />
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10 w-full">
        <div className="w-full max-w-[1100px] mx-auto flex flex-col xl:flex-row gap-8 xl:gap-12 xl:items-center">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, amount: 0.2 }}
            transition={{ duration: 0.8, delay: 0.15, type: "spring", stiffness: 100, damping: 20 }}
