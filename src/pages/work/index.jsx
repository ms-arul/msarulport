...
const Work = () => {
  ...
  return (
    <div className="min-h-screen lg:h-screen flex items-center justify-center bg-primary/30 pb-40 pt-36 lg:pt-[120px] lg:pb-0 overflow-y-auto overflow-x-hidden relative">
      <Circles />
